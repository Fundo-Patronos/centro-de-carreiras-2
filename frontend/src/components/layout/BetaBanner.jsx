    ...
    <div className="fixed top-0 left-0 right-0 z-[60] flex items-center gap-x-6 bg-gray-900 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <p className="text-sm/6 text-white">
        <a href="mailto:contato@patronos.org">
          ...
          Esta é uma nova versão do Centro de Carreiras. Se encontrar algo que não está funcionando, envie um email para contato@patronos.org&nbsp;<span aria-hidden="true">&rarr;</span>
        </a>
      </p>
